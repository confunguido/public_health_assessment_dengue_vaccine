...
## Functions ---------------
##=============================================================================#
plot_color_bar_horizontal = function(myColStrip_in, myColBreaks_in,myColBar_in,
                                     myTicks_in, 
                                     myBarLims_in,
                                     label_in = "",...){
  image(myColStrip_in,
...
##=============================================================================#
summary_list = readRDS('../data/output/20190218_output/summary_cohort_low_coverage_economics_test.RDS')
...
##=============================================================================#
## Heatmaps for cost-effective regions---------
##=============================================================================#
...
if(save.fig == T){
    jpeg(sprintf('../figures/supplement_figure_S11_low_cov_cohort_%.0f_threshold_cost_%s_10y.jpeg',cc, country),
